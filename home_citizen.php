...
<body style="padding: 10px; background-color: rgb(223, 216, 216);">    
    ...
    <div style="padding: 15px 15px; margin-bottom: 20px; display: flex; justify-content: space-between; background-color: aliceblue; border-radius: 0.5rem;">
            <p style="font-size: 40px; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; margin: auto; margin-left:0px; padding: 0px;">Hello user - <?php echo $name; ?></p>
        ...
        <div style="padding: 15px; display: flex; justify-content: space-between; background-color: aliceblue; border-radius: 0.5rem;">
            ...
            <div style="padding: 20px; display: flex; flex-direction: column; justify-content: center; align-items: center; width: 50%;">
                <a href="add_complaint.php"><button class="action-buttons" style="margin-bottom: 50px; min-width: 400px;">ADD COMPLAINT</button></a>
                <a href="complaint_citizen.php?mode=1"><button class="action-buttons" style="margin-bottom: 50px; min-width: 400px;">CURRENT COMPLAINTS</button></a>
                <a href="complaint_citizen.php?mode=2"><button class="action-buttons" style="margin-bottom: 50px; min-width: 400px;">PAST COMPLAINTS</button></a>
                <a href="manage_department.php"><button class="action-buttons" style="min-width: 400px;">VIEW DEPARTMENTS</button></a>
            </div>
        </div>
    </div>
</body>
