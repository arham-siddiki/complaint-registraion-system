...
<body style="padding: 10px; background-color: rgb(223, 216, 216);">    
    <div>
        <div style="padding: 15px 15px; margin-bottom: 20px; display: flex; justify-content: space-between; background-color: aliceblue; border-radius: 0.5rem;">
            <p style="font-size: 40px; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; margin: auto; margin-left: 0px; padding: 0px;">Hello admin - <?php echo $name; ?></p>
        ...
        <div style="padding: 15px; display: flex; justify-content: space-between; background-color: aliceblue; border-radius: 0.5rem;">
            ...
            <div style="padding: 20px; display: flex; flex-direction: column; justify-content: center; align-items: center; width: 50%;">
                <a href="complaint_admin.php?mode=1"><button class="action-buttons" style="margin-bottom: 50px; min-width: 400px;">CURRENT COMPLAINTS</button></a>
                <a href="complaint_admin.php?mode=2"><button class="action-buttons" style="margin-bottom: 50px; min-width: 400px;">PAST COMPLAINTS</button></a>
                <a href="add_department.php"><button class="action-buttons" style="margin-bottom: 50px; min-width: 400px;">ADD DEPARTMENT</button></a>
                <a href="manage_department.php"><button class="action-buttons" style=" min-width: 400px;">MANAGE DEPARTMENTS</button></a>
            </div>
        </div>
    </div>
</body>
